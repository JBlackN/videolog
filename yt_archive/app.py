...
def videos(user = None, tracks = [], subs = [], channel = None, video = None):
    ...
    See also:
        :func:`~yt_archive.web.web_videos()`
    """
...
def channels(user = None, subs = None, tracks = [], tracking = False, error = False):
    ...
    See also:
        :func:`~yt_archive.web.web_channels()`
    """
...
def channels_track(user = None, subs = [], tracks = [], tracking = True, error = False):
    ...
    See also:
        :func:`~yt_archive.web.web_channels_track()`
    """
...
def channels_update():
    ...
    See also:
        :func:`~yt_archive.web.web_channels_update()`
    """
...
def channels_subscriptions():
    ...
    See also:
        :func:`~yt_archive.web.web_channels_subscriptions()`
    """
...
def archive():
    ...
    See also:
        :func:`~yt_archive.web.web_archive()`
    """
...
def archive_insert_rename(type = None, id = None):
    ...
    See also:
        :func:`~yt_archive.web.web_archive_insert_rename()`
    """
...
def archive_batch():
    ...
    See also:
        :func:`~yt_archive.web.web_archive_batch()`
    """
...
def archive_comments():
    ...
    See also:
        :func:`~yt_archive.web.web_archive_comments()`
    """
...
def archive_config():
    ...
    See also:
        :func:`~yt_archive.web.web_archive_config()`
    """
...
def video_play(channel = None, video = None):
    ...
    See also:
        :func:`~yt_archive.api.api_video_play()`
    """
...
def video_unplay(channel = None, video = None):
    ...
    See also:
        :func:`~yt_archive.api.api_video_unplay()`
    """
...
def video_archive(channel = None, video = None):
    ...
    See also:
        :func:`~yt_archive.api.api_video_archive()`
    """
...
def video_unarchive(channel = None, video = None):
    ...
    See also:
        :func:`~yt_archive.api.api_video_unarchive()`
    """
...
def video_rate(channel = None, video = None):
    ...
    See also:
        :func:`~yt_archive.api.api_video_rate()`
    """
...
def video_playlists(channel = None, video = None):
    ...
    See also:
        :func:`~yt_archive.api.api_video_playlists()`
    """
...
def video_subscribe(channel = None, video = None):
    ...
    See also:
        :func:`~yt_archive.api.api_video_subscribe()`
    """
...
def video_unsubscribe(channel = None, video = None):
    ...
    See also:
        :func:`~yt_archive.api.api_video_unsubscribe()`
    """
...
def video_comments(channel = None, video = None):
    ...
    See also:
        :func:`~yt_archive.api.api_video_comments()`
    """
...
def authorize():
    ...
    See also:
        :func:`~yt_archive.auth.auth_authorize()`
    """
...
def oauth2callback():
    ...
    See also:
        :func:`~yt_archive.auth.auth_oauth2callback()`
    """
...
def logout():
    ...
    See also:
        :func:`~yt_archive.auth.auth_logout()`
    """
